...
object PotionSerializer
{
    ...
    fun deserialize(array: JSONArray): MutableCollection<PotionEffect>
    {
        ...
        for (i in 0 until array.size)
        {
            ...
            val effect = if (obj.containsKey("==")) { // Effect was serialized by ConfigurationSerializable
                SerializationHelper.deserialize(obj as Map<String, Any>) as PotionEffect
            } else { // Effect was serialized by hand
